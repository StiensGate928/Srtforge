...
def test_extract_words_from_char_timestamps_when_word_missing() -> None:
    class Hypothesis:
        def __init__(self) -> None:
            self.text = "hello world"
            self.timestamp = {
                "char": [
                    ...
                    {"word": "w", "start": 0.55, "end": 0.65},
                    {"word": "o", "start": 0.65, "end": 0.75},
                    {"word": "r", "start": 0.75, "end": 0.85},
                    {"word": "l", "start": 0.85, "end": 0.95},
                    {"word": "d", "start": 0.95, "end": 1.05},
                ]
            }
    ...
    assert words == [
        ...
        {"word": "world", "start": 0.55, "end": 1.05},
    ]


def test_extract_words_from_segment_timestamps_when_word_missing() -> None:
    class Hypothesis:
        def __init__(self) -> None:
            self.text = "hello world"
            self.timestamp = {
